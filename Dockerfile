...
LABEL org.opencontainers.image.url="https://quay.io/repository/dongheena/cpython_autoconf"
...
LABEL org.opencontainers.image.usage="podman run --rm --pull=always -v $(pwd):/src:Z quay.io/dongheena/cpython_autoconf:271"
